...
#  ./manage.py test natica.tests.TadaTest
#  ./manage.py test
...
class StoreTest(TestCase):
    ...
    def test_store_1(self):
        ...
        expected = {'errorMessage':
                    ...
                    'DETAIL:  Key (md5sum)=(ee801b61d11517e960059e2756e3303c) '
                    'already exists.\n'}
        with open(self.fits1, 'rb') as f:
            response = self.client.post(
                '/natica/store/',
...
class SearchTest(TestCase):
    ...
    def test_search_0(self):
        ...
        jresponse=response.json()
        #print('DBG search_0: jresponse=',pformat(jresponse))
...
#@@@    "image_filter":["raw", "calibrated"],
    ...
    def test_search_error_2(self):
        ...
        #!expected = {"errorMessage": "JSON did not validate against /etc/mars/search-schema.json; 'somethingbad' is not of type 'number'"}
        expected = {"errorMessage": "JSON did not validate against /etc/mars/search-schema.json; 'somethingbad' is not of type 'number'\n\nFailed validating 'type' in schema['properties']['coordinates']['properties']['ra']:\n    {'description': 'An explanation about the purpose of this instance.',\n     'title': 'The Ra Schema',\n     'type': 'number'}\n\nOn instance['coordinates']['ra']:\n    'somethingbad'"}
...
class TadaTest(TestCase):
    ...
    def test_table_prefix(self):
        response = self.client.get('/natica/prefix/')
